...
if ($_SESSION['BACKGROUND']=="Отшельник")
{
	if ($otsh8==1)
	{
		$otsSpec="Я искал духовное просветление";
		$_SESSION['OtshSpec'] =$otsSpec; 
	}
	elseif ($otsh8==2)
	{
		$otsSpec="Я жил в общине согласно предписаниям моей веры. ";
		$_SESSION['OtshSpec'] =$otsSpec; 
	}
	elseif ($otsh8==3)
	{
		$otsSpec="Я был изгнан за преступление, которого не совершал. ";
		$_SESSION['OtshSpec'] =$otsSpec; 
	}
	elseif ($otsh8==4)
	{
		$otsSpec="Я покинул общество после события, изменившего мою жизнь. ";
		$_SESSION['OtshSpec'] =$otsSpec; 
	}
	elseif ($otsh8==5)
	{
		$otsSpec="Мне нужно было тихое место для работы над картиной, книгой, музыкой или манифестом. ";
		$_SESSION['OtshSpec'] =$otsSpec; 
	}
	elseif ($otsh8==6)
	{
		$otsSpec="Мне нужна была община, близкая к природе, вдали от
цивилизации. ";
		$_SESSION['OtshSpec'] =$otsSpec; 
	}
	elseif ($otsh8==7)
	{
		$otsSpec="Я был смотрителем древних руин или реликвии. ";
		$_SESSION['OtshSpec'] =$otsSpec; 
	}
	elseif ($hero10==8)
	{
		$otsSpec="Я был пилигримом, ищущим существо, место или реликвию.";
		$_SESSION['OtshSpec'] =$otsSpec;
	}
